                      ...
                      <tbody>
                        {report.reserves.map((reserve, index) => (
                          <tr key={reserve.id || index}>
                            <td className=" text-center inline-flex items-center justify-center h-6 w-6 rounded-full bg-orange-100 text-orange-800 border border-orange-500 font-medium text-xs">
                              {index + 1}
                            </td>
