                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4 text-sm border-b pb-2">
                      ...
                      <span className="ml-2"><strong>P</strong> : Présent</span>
                      <span className="ml-4"><strong>R</strong> : Retard</span>
                      <span className="ml-4"><strong>A</strong> : Absent</span>
                    </div>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {report.participants ? report.participants.map((participant, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell className="text-center">
                              <Badge className={
                                participant.presence === 'P' ? "bg-green-500" : 
                                participant.presence === 'R' ? "bg-yellow-500" : 
                                "bg-red-500"}>
