                ...
                <Card className="rounded-t-none border-t-0">
                  <CardContent className="p-6">
                    <Table>
                      ...
                      <TableBody>
                        {report.participants && report.participants.length > 0 ? report.participants.map((participant, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell className="text-center">
                              <Badge
                                className={
                                  ...
                                  participant.presence === 'R' ? "bg-orange-500" : 
                                  participant.presence === 'A' ? "bg-red-500" :
                                  "bg-blue-500"
                                }
                              >
