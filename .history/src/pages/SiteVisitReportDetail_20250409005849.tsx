        ...
        <Card className="mb-6 print:shadow-none print:border-none">
          ...
          <CardContent className="pt-6">
            <div className="space-y-6">
              ...
              {shouldShowSection("reserves") && report.reserves && report.reserves.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-lg font-medium mb-2">Réserves et annotations</h3>
                    ...
                    <tbody>
                      {report.reserves.map((reserve, index) => (
                        <tr key={reserve.id || index}>
                           <td className="border p-2">{reserve.lot}</td>
                          <td className="border p-2">{reserve.lot}</td>
                          <td className="border p-2">{reserve.location}</td>
                          <td className="border p-2">{reserve.description}</td>
                          <td className="border p-2">{formatDate(reserve.createdAt)}</td>
                          <td className="border p-2">
                            {reserve.status === "resolved" ? (
                              <div className="flex items-center">
                                <Badge variant="outline" className="bg-green-50 border-green-300 text-green-700">
                                  Levée le {formatDate(reserve.resolvedAt || "")}
                                </Badge>
                              </div>
                            ) : (
                  ...
                  {/* Afficher les photos associées aux réserves */}
                  <div className="mt-4">
                    <h4 className="font-medium mb-2">Photos des réserves</h4>
            ...
            <div className="bg-white p-6 min-h-[600px]">
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm">15 rue de l'Innovation, 75001 Paris</p>
                  </div>
                </div>
                <div className="text-right">
                  <h3 className="font-bold text-lg">COMPTE RENDU DE VISITE</h3>
                  <p className="text-sm">Réf: {report.reportNumber}</p>
                  <p className="text-sm">Date de visite: {formatDate(report.visitDate)}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <p>{project.client}</p>
                  <p className="text-sm">Période: {formatDate(project.startDate)} - {formatDate(project.endDate)}</p>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="bg-gray-100 p-3 mb-2 flex justify-between items-center">
                  ...
                  <div className="flex gap-3 text-xs">
                    <span><strong className="border rounded-full w-5 h-5 inline-block text-center border-green-600 text-green-600">P</strong> Présent</span>
                    <span><strong className="border rounded-full w-5 h-5 inline-block text-center border-orange-600 text-orange-600">R</strong> Retard</span>
                    <span><strong className="border rounded-full w-5 h-5 inline-block text-center border-red-600 text-red-600">A</strong> Absent</span>
                    <span><strong className="border rounded-full w-5 h-5 inline-block text-center border-blue-600 text-blue-600">E</strong> Excusé</span>
                  </div>
                </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="py-1 text-center">
                          <span className="inline-block border rounded-full w-5 h-5 text-center border-green-600 text-green-600">P</span>
                        </td>
                      </tr>
                      <tr>
                  ...
                  <table className="w-full text-sm border">
                    <thead>
                      <tr className="bg-gray-50">
                        ...
                        <th className="text-left p-2 border">Action requise</th>
                        ...
                        <tr key={rec.id} className="border-b">
                          ...
                          <td className="p-2 border">
                            {rec.status === "pending" ? "En attente" : 
                             rec.status === "in-progress" ? "En cours" :
                             rec.status === "completed" ? "Terminé" : rec.status}
                          </td>
                        </tr>
                      ))}
                    </tbody>
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div className="border p-3 text-center">
                      ...
                      <div className="h-16 flex items-center justify-center">
                        {report.signatures.inCharge ? (
                          <img src={report.signatures.inCharge} alt="Signature responsable" className="h-12" />
                        ) : (
                    ...
                    <div className="border p-3 text-center">
                      ...
                      <div className="h-16 flex items-center justify-center">
                        {report.signatures.engineer ? (
                          <img src={report.signatures.engineer} alt="Signature ingénieur" className="h-12" />
                        ) : (
                          <p className="text-xs text-gray-400">Signature non disponible</p>
                        )}
                      </div>
                    ...
                    <div className="border p-3 text-center">
                      ...
                      <div className="h-16 flex items-center justify-center">
                        {report.signatures.visitor ? (
                          <img src={report.signatures.visitor} alt="Signature visiteur" className="h-12" />
                        ) : (
                          <p className="text-xs text-gray-400">Signature non disponible</p>
                        )}
                      </div>
              ...
              <div className="text-center text-xs text-gray-500 mt-8 pt-4 border-t">
                <p>
                  Cabinet d'Architecture Moderne - 15 rue de l'Innovation, 75001 Paris
                </p>
                ...
                <p>© {new Date().getFullYear()} Cabinet d'Architecture Moderne</p>
              </div>
            </div>
          </div>
