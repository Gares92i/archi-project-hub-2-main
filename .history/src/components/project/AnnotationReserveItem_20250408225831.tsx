...
import { Trash2, Upload, Calendar as CalendarIcon, X, Image, Plus } from "lucide-react";
    ...
    return (
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <label className="text-sm font-medium mt-3 mb-1 block">Localisation</label>
          <Input
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex flex-wrap gap-3 items-center">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-[150px] justify-start text-left font-normal">
                    ...
                    {reserve.createdAt ? formatDate(reserve.createdAt) : "Sélectionner"}
                  </Button>
                </PopoverTrigger>
            ...
            <div>
              <label className="text-sm font-medium mb-1 block">Levée le</label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="w-[150px] justify-start text-left font-normal">
                    <CalendarIcon className="mr-2 h-4 w-4" />
                    {reserve.resolvedAt ? formatDate(reserve.resolvedAt) : "Non levée"}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0">
                  <Calendar
              ...
              <div className="flex items-center space-x-2">
                {reserve.photos && reserve.photos.length > 0 ? (
                  <div className="flex gap-2 overflow-x-auto">
                    {reserve.photos.map((photo, idx) => (
                      <div key={idx} className="relative group">
                        <img 
                          src={photo}
                          alt={`Photo ${idx + 1}`}
                          className="h-14 w-14 object-cover rounded-md cursor-pointer border"
