      ...
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>Actions à entreprendre suite à la visite</CardDescription>
          </div>
      ...
      <CardContent>
        {recommendations.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 border-2 border-dashed rounded-lg">
            <p className="text-muted-foreground">Aucune recommandation ajoutée</p>
          ...
          >
            <div className={cn("w-full", isMobile && "overflow-x-auto")}>
              <Table>
                ...
                <TableBody>
                  <SortableContext items={recommendations.map(rec => rec.id)} strategy={verticalListSortingStrategy}>
