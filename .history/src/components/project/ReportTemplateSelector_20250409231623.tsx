...
export const reportTemplates = [
  {
    ...
    icon: FileText,
    fields: ["participants", "reserves", "observations", "recommendations", "photos", "documentsWithAnnotations" ,"signatures"]
  },
  {
    id: "simple",
    ...
    icon: Layout,
    fields: ["participants", "reserves", "observations", "photos", "documentsWithAnnotations"]
  },
  {
    id: "detailed",
    ...
    icon: FileText,
    fields: ["participants", "reserves", "observations", "recommendations", "photos", "documentsWithAnnotations" ,"signatures", "documents", "additionalDetails"]
  }
];
