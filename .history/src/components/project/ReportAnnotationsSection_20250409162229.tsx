...
export const ReportAnnotationsSection: React.FC<ReportAnnotationsSectionProps> = ({
  ...
  useEffect(() => {
    ...
    console.log(
      "Annotations avec lot:",
      annotations.filter((a) => a.lot)
    );
    console.log(
      "Annotations avec localisation:",
      annotations.filter((a) => a.location)
    );
  }, [annotations]);
  ...
  const addReserveFromAnnotation = (annotation: Annotation) => {
    ...
    const newReserve: AnnotationReserve = {
      ...
      status:
        annotation.resolved || annotation.isResolved ? "resolved" : "pending",
  ...
  const addMultipleReservesFromAnnotations = (
