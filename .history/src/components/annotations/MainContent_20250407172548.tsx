...
import { Trash2, Edit, Move, ZoomIn, ZoomOut, RotateCw, ArrowsPointingOut } from "lucide-react";
...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center mr-4 bg-background/70 rounded-md px-1.5 py-1">
            ...
            <Button 
              ...
              title="Réinitialiser"
            >
              <ArrowsPointingOut className="h-3.5 w-3.5" />
            </Button>
          </div>
      ...
      >
        {/* Conteneur du document avec zoom et rotation */}
        <div 
          style={{ 
