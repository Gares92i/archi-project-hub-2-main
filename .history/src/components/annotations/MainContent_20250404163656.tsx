  ...
  return (
    <div className="flex-1 flex flex-col relative bg-gray-100 dark:bg-gray-900 h-full">
      ...
      <div className="bg-card border-b p-2 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          >
            {isAddingAnnotation ? (
              ...
              <>
                <AnnotationIcon className="h-4 w-4 mr-1" /> Annoter
              </>
            )}
          </Button>
          <Button variant="outline" size="sm" onClick={() => handleZoom(0.1)} title="Zoom avant">
            <Plus className="h-4 w-4" />
          </Button>
          <Button variant="outline" size="sm" onClick={() => handleZoom(-0.1)} title="Zoom arrière">
        ...
        <div className="flex items-center space-x-2">
          <Button variant="outline" size="sm" onClick={handleUploadClick} title="Importer un document">
            <Upload className="h-4 w-4 mr-1" /> Importer
          </Button>
          <Button variant="outline" size="sm" onClick={handleFullscreen} title="Plein écran">
