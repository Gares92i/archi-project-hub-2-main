...
/*************  ✨ Windsurf Command ⭐  *************/
  /**
   * FileUploader est un composant qui permet de charger un document
   * (PDF ou image) et de l'envoyer à un composant parent pour traitement.
   * Il gère également l'optimisation des images pour les rendre plus légères.
   *
   * @param onDocumentUpdate Fonction qui sera appelée lorsque le document sera prêt
   * @param fileInputRef Référence vers l'élément input de type file
   * @returns Un JSX qui contient un input de type file caché et un dialogue pour saisir le nom du document
   */

/*******  f724b2e4-e4cf-4390-8664-271dda9a9e06  *******/
