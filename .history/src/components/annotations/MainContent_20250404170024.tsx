    ...
    <div className="flex-1 flex flex-col relative bg-gray-100 dark:bg-gray-900 h-full">
      ...
      <div className="flex-1 overflow-hidden relative">
        <div
          ...
          {/* MODIFICATION ICI: Appliquer les transformations directement au document */}
          {activeDocument && (
            <div 
            ...
            >
              {activeDocument && activeDocument.url && activeDocument.url !== '/placeholder.svg' ? (
                ...
                <div className="flex flex-col items-center justify-center p-8 bg-muted/20 rounded-lg min-w-[500px] min-h-[400px]">
                  <p className="text-muted-foreground mb-2 text-center">
                    {activeDocument ? "Document sans contenu valide" : "Aucun document sélectionné"}
                  </p>
                  {activeDocument && (
                    <p className="text-sm text-muted-foreground/70 text-center">
                      Cliquez sur "Importer" pour ajouter un fichier à ce document
                    </p>
                  )}
                </div>
              )}
