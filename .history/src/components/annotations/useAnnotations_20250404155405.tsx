...
export const useAnnotations = (initialDocuments: Document[], projectId: string) => {
  ...
  const addNewDocument = useCallback(
    (url: string, name: string, type: "pdf" | "img") => {
      ...
      // Créer une nouvelle liste de documents avec le nouveau document ajouté
      ...
      // Sauvegarder immédiatement dans le localStorage pour éviter les pertes
      const stateToSave = {
      ...
      // Mettre à jour la référence du dernier état enregistré
