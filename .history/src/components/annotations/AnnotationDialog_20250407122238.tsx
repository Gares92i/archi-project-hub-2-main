...
import { PlusCircle, X, CheckCircle, Circle, Calendar } from "lucide-react";
...
interface AnnotationDialogProps {
  ...
  onUpdateLot?: (id: string, lot: string) => void;
  onUpdateLocation?: (id: string, location: string) => void;
  onUpdateResolvedDate?: (id: string, date: string | undefined) => void;
}
