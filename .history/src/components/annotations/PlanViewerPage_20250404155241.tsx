...
export const PlanViewerPage = () => {
  ...
  // Fonction handleAddNewDocument modifiée pour corriger les problèmes d'ajout de documents
  const handleAddNewDocument = (url: string, filename: string) => {
    ...
    // Sinon, créer un nouveau document
      ...
      // Mettre à jour directement l'état local des documents
      const updatedDocuments = [...documents, newDocument];
      setDocuments(updatedDocuments);
      handleSelectDocument(newDocument); // Sélectionner automatiquement le nouveau document
      
      console.log("Nouveau document ajouté:", filename, "Total documents:", updatedDocuments.length);
