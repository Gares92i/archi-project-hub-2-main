import { useEffect, useCallback, useRef } from 'react'; // Ajouter useRef
...
export const usePlanViewer = ({
  ...
  // Créer une référence pour le conteneur du canvas
  ...
  return {
    canvasRef,
    canvasContainerRef, // Retourner la référence réelle et non null
    isLoading,
    isPanning,
    isAddingAnnotation,
    handleZoomIn,
    ...
    handleTogglePanning,
    handleToggleAddAnnotation,
    handleReset, // Utiliser la fonction réelle
    handleDownloadImage
  };
};
