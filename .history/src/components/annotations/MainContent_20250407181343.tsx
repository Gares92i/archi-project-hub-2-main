    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      <div className="bg-muted py-1 px-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          {/* Contrôles de zoom et rotation - GARDER UNIQUEMENT CETTE BARRE */}
      ...
      <div
        ...
        {/* Passage des props pour désactiver les contrôles dans les composants enfants */}
        {isPdf ? (
          <PdfViewer url={activeDocument.url} hideControls={true} />
        ) : (
