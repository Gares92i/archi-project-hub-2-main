...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  // Ajoutez cette fonction pour mieux gérer les clics sur les PDF
  const handlePdfClick = (e: React.MouseEvent) => {
    ...
    // Calculer la position relative dans l'iframe
    const x = (e.clientX - rect.left) / rect.width;
    const y = (e.clientY - rect.top) / rect.height;
    
    // S'assurer que le clic est dans l'iframe
    if (x >= 0 && x <= 1 && y >= 0 && y <= 1) {
      console.log("Ajout d'annotation sur PDF à la position:", { x, y });
      onAddAnnotation({ x, y });
      setIsAddingAnnotation(false);
    }
  };
                  ...
                  <div className="relative" style={{ width: "900px", height: "700px" }}>
                    <iframe
                      ...
                      style={{
                        ...
                        border: "none",
                        background: "white",
                        pointerEvents: isAddingAnnotation ? "none" : "auto" // Désactiver les clics sur l'iframe en mode annotation
                      }}
                    />
                    <div 
