    ...
    const loadImage = () => {
      ...
      imgElement.onload = () => {
        try {
          ...
          if (!fabricCanvas || !canvasRef.current || !canvasContainerRef.current) {
            console.warn('Canvas non disponible pour le chargement de l\'image');
            return;
          }
          ...
          // Utiliser une méthode plus sûre que clear() qui peut causer l'erreur clearRect
