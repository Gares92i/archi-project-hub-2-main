...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  const handleMouseDown = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    e.preventDefault(); // Important pour éviter les sélections de texte
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div
        ...
        onClick={!isMoveMode ? handleDocumentClick : undefined}
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          {sortedAnnotations.map((annotation, index) => {
            // Extraire les 4 derniers caractères de l'ID pour l'affichage
            const displayId = annotation.id.substring(annotation.id.length - 4);
            ...
            return (
              <div key={annotation.id} className="group relative">
                <AnnotationMarker
                  ...
                  annotationNumber={parseInt(displayId, 16) || index + 1} // Utiliser l'ID comme numéro ou fallback à l'index
                  onClick={() => {
