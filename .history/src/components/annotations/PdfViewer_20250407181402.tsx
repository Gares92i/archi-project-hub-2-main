...
interface PdfViewerProps {
  url: string;
  hideControls?: boolean; // Nouvelle prop
}

export const PdfViewer: React.FC<PdfViewerProps> = ({ url, hideControls = false }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Afficher la barre d'outils uniquement si hideControls est false */}
      {!hideControls && (
