...
export const PlanViewer: React.FC<PlanViewerProps> = ({ 
 ...
 }, [annotations, selectedAnnotation, isInitialized, canvas, isAddingAnnotation, isPanning, onAnnotationClick, addAnnotation, annotationObjects]);isAddingAnnotation, isPanning, onAnnotationClick, addAnnotation]);
