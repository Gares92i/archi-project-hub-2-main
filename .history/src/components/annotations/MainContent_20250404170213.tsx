...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  const renderAnnotations = () => {
    ...
    return annotations.map((ann) => {
      ...
      // Appliquer uniquement la translation (pas le zoom et la rotation)
      const posX = baseX * zoomLevel + dragOffset.x;
      const posY = baseY * zoomLevel + dragOffset.y;
    ...
    <div className="flex-1 flex flex-col relative bg-gray-100 dark:bg-gray-900 h-full">
      ...
      <div className="flex-1 overflow-hidden relative">
        <div
          ...
          onClick={handleClick}
        >
          {/* Contenu du document avec style stable */}
          <div 
            style={{
              position: 'absolute',
              left: '50%',
              ...
              width: '100%',
              height: '100%',
              willChange: 'transform', // Aide à la stabilité visuelle
            }}
          >
            <div 
              style={{ 
              ...
              {activeDocument && activeDocument.url && activeDocument.url !== '/placeholder.svg' ? (
                ...
                <div className="flex items-center justify-center h-full">
                  <div className="text-center">
                    <p className="text-muted-foreground">Aucun document sélectionné ou valide</p>
                  </div>
                </div>
              )}
            </div>
