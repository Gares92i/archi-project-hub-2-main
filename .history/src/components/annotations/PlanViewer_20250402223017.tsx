...
import { safeDisposeFabricCanvas, createSafeFabricCanvas, calculateImageScale, centerImageInCanvas } from './utils/fabricHelpers';
    ...
    const loadImage = () => {
      ...
      imgElement.onload = () => {
        try {
          ...
          // Utiliser les fonctions utilitaires pour mise à l'échelle
          ...
          // Utiliser la fonction utilitaire pour centrer l'image
          centerImageInCanvas(
            fabricImage,
            scale,
            container.clientWidth,
