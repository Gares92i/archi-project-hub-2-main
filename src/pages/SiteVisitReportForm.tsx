...
import { ParticipantsSection } from "@/components/project/ParticipantsSection"; // Importez le composant
import { ReportAnnotationsSection } from "@/components/project/ReportAnnotationsSection"; // Importer le nouveau composant
    ...
    <MainLayout>
      <div className="flex items-center mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">
            {isEditing ? "Modifier le" : "Nouveau"} Compte Rendu de Visite
          </h1>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          {/* Section Participants - Ajoutée juste après Informations générales */}
          <ParticipantsSection />
